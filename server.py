...
#tokens = new_corpus.words('sample.txt')
tokens = brown.words()# + reuters.words()# + new_corpus.words('txt/corpus (4).txt')
#for i in range(2,5):
#    tokens = tokens + new_corpus.words('txt/corpus (' + str(i) + ').txt')
